...
class InvoiceDetailsControllerTest < ActionController::TestCase
  ...
  test "should create invoice_detail" do
    assert_difference('InvoiceDetail.count') do
      post :create, invoice_detail: { ImportoNoVatSingolo: @invoice_detail.ImportoNoVatSingolo, Qta: @invoice_detail.Qta, VAT: @invoice_detail.VAT, descrizione: @invoice_detail.descrizione, invoice_id: @invoice_detail.invoice_id }
    end
  ...
  test "should update invoice_detail" do
    patch :update, id: @invoice_detail, invoice_detail: { ImportoNoVatSingolo: @invoice_detail.ImportoNoVatSingolo, Qta: @invoice_detail.Qta, VAT: @invoice_detail.VAT, descrizione: @invoice_detail.descrizione, invoice_id: @invoice_detail.invoice_id }
    assert_redirected_to invoice_detail_path(assigns(:invoice_detail))
  end
